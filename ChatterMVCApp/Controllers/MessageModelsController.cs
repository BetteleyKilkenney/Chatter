...
using ChatterMVCApp.Models;

namespace ChatterMVCApp.Controllers
{
    public class MessageModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MessageID,MessageText,MessageTimeStamp,ApplicationUser_Id")] MessageModel messageModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MessageID,MessageText,MessageTimeStamp")] MessageModel messageModel)
        {
            if (ModelState.IsValid)
            {
